...
# You can set this variable whatever you want in shell session right before running this script by issuing:
# export JSON_PATH='/home/xray'
JSON_PATH=${JSON_PATH:-/home/xray}

# Set this variable only if you are starting xray with multiple configuration files:
# export JSONS_PATH='/home/xray'
...
ExecStart=/home/xray/xray run -config /home/xray/config.json
Restart=on-failure
...
${temp_AmbientCapabilities}
${temp_NoNewPrivileges}
ExecStart=/home/xray/xray run -config /home/xray/%i.json
Restart=on-failure
RestartPreventExitStatus=23
LimitNPROC=10000
LimitNOFILE=1000000
